...
do
    ...
    python score_model.py --ID_dataset $dataset --OOD_datasets $ood_datasets --model $model_name --model_seed $model_seed --run_name $run_name --score swag --swag_n_vec $n_vec --swag_lr 1e-3 --swag_momentum 0.99 --swag_collect_interval 100 --train_batch_size 128 --test_batch_size 32
done
