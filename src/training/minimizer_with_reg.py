...
def maximum_a_posteriori_with_reg(
    ...
    if not model_has_batch_stats:
        @jax.jit
        def train_step(n_epoch, opt_state, params_dict, x, y):
    ...
    for epoch in range(1, args_dict["n_epochs"] + 1):
        ...
        for batch in train_loader:
            ...
            opt_state, params_dict, batch_loss, batch_acc_or_sse = train_step(epoch, opt_state, params_dict, X, Y)
